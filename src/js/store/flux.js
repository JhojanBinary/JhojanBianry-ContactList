	...
	return {
		...
		actions: {
			...
			changeColor: (index, color) => {
			 ...
			 addContact: (contact) => {
				const contactURL = "https://playground.4geeks.com/contact/agendas/JhojanBinary/contacts";
				fetch(contactURL, {
					method: "POST",
            ...
            deleteContact: index => {
				...
				const contactURL = "https://playground.4geeks.com/contact/agendas/"
                fetch(contactURL + 'JhojanBinary/contacts/' + contactId, {
                    method: "DELETE"
                })
                    .then(response => {
                        if (!response.ok) {
			...
			updateContact: (id, updatedContact) => {
				const contactURL = "https://playground.4geeks.com/contact/agendas/"
				fetch(contactURL + 'JhojanBinary/contacts/' + id, {
					method: "PUT",
